...
class _HomeScreenState extends BaseState<HomeScreen> {
  ...
  getCurrentAddress() async{
    ...
    handleRes(res: home.currentAddressRes!, context: context,retryCall: (){
      getCurrentAddress();
    });
  }
  ...
  getPermanentAddress() async{
    ...
    handleRes(res: home.permanentAddressRes!, context: context,retryCall: (){
      getCurrentAddress();
    });
  }
            ...
            child: Column(
              children: [
                ...
                titleIconButtons(
                    ...
                    onTap: () {
                      Provider.of<ProfileProviderImpl>(context,listen: false).getSkillHobbyByUserId();
                ...
                titleIconButtons(
                    ...
                    onTap: () {
                      Provider.of<ProfileProviderImpl>(context,listen: false).getFamilyMemberByUserId();
                      Navigator.of(context).push(MaterialPageRoute(
  ...
  Widget userBasicDetailConsumer() {
    ...
    return Consumer<ProfileProviderImpl>(builder: (_, profile, __) {
      ...
      final hasError = profile.userRes?.state == Status.ERROR || profile.userRes?.state == Status.UNAUTHORISED;

      if(hasError){
        return bgContainer(widget: NoDataFoundView(retryCall: (){
          getUserData();
  ...
  Widget currentAddressConsumer() {
    return Consumer<ProfileProviderImpl>(builder: (_, profile, __) {
      ...
      final hasError = profile.currentAddressRes?.state == Status.ERROR || profile.currentAddressRes?.state == Status.UNAUTHORISED;
  ...
  Widget permanentAddressConsumer() {
    return Consumer<ProfileProviderImpl>(builder: (_, profile, __) {
      ...
      final hasError = profile.permanentAddressRes?.state == Status.ERROR || profile.permanentAddressRes?.state == Status.UNAUTHORISED;
  ...
  Widget professionConsumer() {
    ...
    return Consumer<ProfileProviderImpl>(builder: (_, profile, __) {
      ...
      final hasError = profile.occupation?.state == Status.ERROR || profile.occupation?.state == Status.UNAUTHORISED;
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (!isLoading && gurukul1 != null || gurukul2 != null && !hasError)
              Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  if(gurukul1 != null)
            ...
            if(hasError)
              NoDataFoundView(title: 'No Gurukuls Found',retryCall: (){
                getGurukulList();
              },),
            defaultSizeBoxHeight(height: 10),
          ],
