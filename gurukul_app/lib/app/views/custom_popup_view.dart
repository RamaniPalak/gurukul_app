                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(title,style: kTitleStyle,textAlign: TextAlign.center,),
                            ),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    child: Text(secondaryBtnTxt ?? "",style: kTitleStyle.copyWith(color: kPrimaryColor),),
                                  ),
                                ),
                              ),
                            if(secondaryBtnTxt != null)
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: TextButton(
                                  ...
                                  child: Text(primaryBtnTxt,style: kTitleStyle.copyWith(color: Colors.white),),
                                ),
                              ),
                            ),
                          ],
